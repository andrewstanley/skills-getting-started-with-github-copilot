...
activities = {
    ...
    "Soccer Team": {
        "description": "Competitive soccer team that plays matches against other schools",
        "schedule": "Mondays, Wednesdays, 4:00 PM - 6:00 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Casual and competitive basketball sessions and intramurals",
    ...
    "Math Club": {
        ...
        "max_participants": 20,
        "participants": ["ethan@mergington.edu", "noah2@mergington.edu"]
    },
    "Science Olympiad": {
